...
export default function RequestAccessPage() {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 flex flex-col items-center justify-center p-4">
                <motion.div
                    ...
                    className="bg-white dark:bg-slate-900 p-10 rounded-3xl shadow-2xl max-w-lg w-full text-center border border-slate-200 dark:border-slate-800"
                >
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 flex flex-col items-center justify-center p-4 md:p-8">
            <div className="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white dark:bg-slate-900 rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800">

                {/* Left Side: Info */}
                <div className="bg-brand-navy p-10 flex flex-col justify-between text-white relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-brand-green/20 rounded-fullblur-3xl -mr-16 -mt-16 blur-2xl"></div>
                    <div className="absolute bottom-0 left-0 w-48 h-48 bg-purple-500/20 rounded-full blur-3xl -ml-10 -mb-10 blur-2xl"></div>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-slate-200 leading-relaxed text-lg">
                            Beyond Limits platformunun gelişmiş özelliklerine erişmek için işletme hesabınızı oluşturun.
                        </p>
