            ...
            <div className="flex h-screen bg-emerald-50 dark:bg-emerald-950/20 overflow-hidden font-geist-sans">
                ...
                <aside className="w-64 bg-emerald-900 text-emerald-50 flex flex-col hidden md:flex">
                    ...
                    <nav className="flex-1 px-4 py-8 space-y-2">
                        <Link href="/consult" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-emerald-800 transition-colors">
                            <Map className="w-5 h-5 text-emerald-400" />
                            <span className="font-medium">Genel Bakış</span>
                        </Link>
                        <Link href="/consult/compass" className="flex items-center gap-3 px-4 py-3 rounded-lg bg-emerald-800/50 hover:bg-emerald-800 transition-colors border border-emerald-700/50">
                        ...
                        <div className="pt-4 mt-4 border-t border-emerald-800/50">
                            ...
                            <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-emerald-800 transition-colors text-left">
                    ...
                    <div className="p-4 border-t border-emerald-800">
                        <Link href="/corp/dashboard" className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-emerald-800 transition-colors text-emerald-200 hover:text-white">
                            <LogOut className="w-5 h-5" />
                            <span className="font-medium">Kurumsal Panele Dön</span>
                        </Link>
                    </div>
                </aside>
                ...
                <main className="flex-1 flex flex-col h-full overflow-hidden relative">
                    <header className="h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-emerald-100 dark:border-emerald-900/50 flex items-center justify-between px-8 flex-shrink-0 z-10">
                        <h1 className="text-sm font-bold text-emerald-800 dark:text-emerald-400 uppercase tracking-wider">
                            Danışmanlık Merkezi
                        </h1>
                    ...
                    <div className="flex-1 overflow-y-auto w-full relative">
                        ...
                        <div className="absolute top-0 left-0 w-full h-96 bg-emerald-200/30 dark:bg-emerald-900/10 blur-3xl -z-10 rounded-b-full"></div>
                        {children}
                    </div>
                </main>
            </div>
