    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white">Sosyal Medya Yönetimi</h1>
                    <p className="text-slate-500 dark:text-slate-400">Gönderilerinizi tek bir merkezden planlayın, paylaşın ve analiz edin.</p>
                </div>
                <button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl font-medium transition-colors shadow-sm shadow-blue-600/20">
                    <Plus size={20} />
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 min-h-[500px]">
                ...
                {activeTab === "calendar" && (
                    <div className="flex flex-col items-center justify-center h-[400px] text-center space-y-4">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Henüz Planlanmış Gönderi Yok</h2>
                ...
                {activeTab === "accounts" && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-blue-500/50 transition-colors">
                            ...
                            <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-pink-500/50 transition-colors">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                            ...
                            <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 hover:border-slate-500/50 transition-colors bg-slate-50/50 dark:bg-slate-800/20 border-dashed">
