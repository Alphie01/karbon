        ...
        <div className="p-6 max-w-5xl mx-auto print:p-0 print:max-w-none">
            ...
            <div className="bg-white p-12 rounded-xl border border-slate-200 shadow-sm print:border-none print:shadow-none print:p-0">
                ...
                <div className="flex justify-between items-start mb-12">
                    <div>
                        {/* Logo Area */}
                        <div className="h-16 w-16 bg-slate-900 dark:bg-white rounded-2xl flex items-center justify-center font-black text-white dark:text-slate-900 text-2xl mb-6 shadow-xl shadow-slate-900/10 print:shadow-none print:border-2 print:border-slate-900 print:text-slate-900">
                            BL
                        </div>
                    ...
                    <div className="text-right text-sm text-slate-600">
                        <p className="font-bold text-slate-900 text-lg">Beyond Limits</p>
                        <p>Teknopark İstanbul</p>
                        <p>Pendik, İstanbul</p>
                        <p>info@beyondlimits.com</p>
                    </div>
                </div>
                ...
                <div className="mt-32 grid grid-cols-2 gap-20 print:visible hidden">
                    <div className="text-center pt-8 border-t-2 border-slate-900/10">
                        ...
                        <p className="font-black text-lg text-slate-900">Beyond Limits</p>
