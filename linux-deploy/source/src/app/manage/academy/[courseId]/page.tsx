...
export default async function CourseDetailPage({ params }: { params: Promise<{ courseId: string }> }) {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/10 border border-emerald-100 dark:border-emerald-800/50 p-6 rounded-2xl flex flex-col md:flex-row gap-6 items-center md:items-start">
                {course.thumbnail ? (
