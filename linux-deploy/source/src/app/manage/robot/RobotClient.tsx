        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            {step === 1 && (
                <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl border border-slate-200 dark:border-slate-800 text-center">
                    ...
                    <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-white">Akıllı Hibe Asistanı</h2>
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold flex items-center gap-2 mx-auto transition-all"
                    >
            ...
            {step === 4 && (
                <div className="space-y-8">
                    ...
                    {drafts.map((draft, idx) => (
                        <div key={idx} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm">
