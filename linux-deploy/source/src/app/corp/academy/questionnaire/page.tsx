...
export default function QuestionnairePage() {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 animate-in fade-in duration-500 py-12">
            ...
            }} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm space-y-12">
