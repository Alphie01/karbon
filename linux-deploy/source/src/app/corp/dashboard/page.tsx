    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 max-w-[1400px] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-8 shadow-sm relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-indigo-600 to-violet-700 p-8 rounded-3xl text-white shadow-xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl font-black mb-2">Hibe & Teşvik Robotu</h3>
                        <p className="text-indigo-100 mb-8 max-w-sm leading-relaxed">
                            Analiz motorumuz {carbonEntries.length} veri girişini ve su profilini taradı. Gemlik bölgesi için uygun hibe fırsatları belirlendi.
                        </p>
                        <Link href="/corp/robot" className="px-8 py-3 bg-white text-indigo-700 font-black rounded-xl inline-flex items-center gap-2 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                            Robotu Çalıştır <ArrowRight size={18} />
                        </Link>
                    </div>
                </div>

                <div className="bg-slate-900 p-8 rounded-3xl text-white shadow-xl border border-slate-800 relative overflow-hidden group">
                    <div className="absolute top-0 right-0 p-8 text-slate-800">
                        <Factory size={120} />
                    </div>
                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-4">
                            <span className="bg-emerald-500 text-[10px] font-black px-2 py-0.5 rounded text-white uppercase">AI SIM</span>
                        </div>
                        <h3 className="text-2xl font-bold mb-2">Senaryo Simülasyonu</h3>
                        <p className="text-slate-400 mb-8 max-w-sm leading-relaxed">
                            &quot;GES yatırımı yaparsam karbon ayak izim ne kadar düşer?&quot; gibi senaryoları PySD motoruyla test edin.
                        </p>
                        <Link href="/corp/simulation" className="px-8 py-3 bg-white text-slate-900 font-black rounded-xl inline-flex items-center gap-2 hover:shadow-2xl transition-all transform hover:-translate-y-1">
                            Simülasyona Git <ArrowRight size={18} />
                        </Link>
                    </div>
                </div>
            </div>
