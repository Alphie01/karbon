                ...
                <div className="lg:col-span-2 space-y-6">
                    {filteredArticles.length === 0 ? (
                        ...
                        filteredArticles.map((article: any) => {
                            ...
                            return (
                                <div key={article.id} className="bg-white dark:bg-slate-900 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 hover:border-purple-300 dark:hover:border-purple-900 transition-all group relative overflow-hidden">
                                    {showNewBadge && (
