    ...
    return (
        <div className="p-8 max-w-6xl mx-auto ">
            <div className="mb-12">
                ...
                <h1 className="text-xl font-bold text-emerald-900 dark:text-emerald-50 tracking-tight mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white dark:bg-slate-900 rounded-xl p-8 shadow-xl shadow-emerald-900/5 border border-emerald-100 dark:border-emerald-800/50">
                ...
                <div className="bg-emerald-50 dark:bg-emerald-900/10 rounded-xl p-8 border border-emerald-100 dark:border-emerald-800/30 flex flex-col justify-center">
                    <h3 className="text-xl font-bold text-emerald-900 dark:text-emerald-100 mb-4">Hemen Başlayın</h3>
                    ...
                    <Link href="/consultancy/compass" className="inline-flex items-center justify-center gap-2 bg-emerald-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-emerald-500 transition-colors w-full sm:w-auto ">
