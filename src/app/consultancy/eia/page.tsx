    ...
    return (
        <div className="p-8 max-w-6xl mx-auto ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                <div className="bg-white dark:bg-slate-900 rounded-xl p-8 border border-emerald-100 dark:border-emerald-800/50">
                ...
                <div className="bg-emerald-600 rounded-xl p-8 border border-emerald-500 flex flex-col justify-center text-white">
                    <ShieldCheck className="w-10 h-10 text-emerald-200 mb-6" />
                    <h3 className="text-xl font-bold mb-4">Risk Almayın</h3>
