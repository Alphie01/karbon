...
export default function WaterTabs({ initialReports, report: propReport, companyId, businessProcesses = [] }: WaterTabsProps) {
    ...
    if (!report && !isCreating) {
        return (
            <div className="flex flex-col items-center justify-center p-12 bg-white dark:bg-slate-900 rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-800">
    ...
    return (
        <div className="space-y-6 ">
            ...
            {isCreating && (
                <div className="bg-blue-600 p-1 rounded-xl ">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-b-xl border border-slate-200 dark:border-slate-800 p-8 min-h-[600px] shadow-sm ">
                ...
                {activeTab === "kurumsal" && (
                    <div className="space-y-8 max-w-3xl ">
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/40 p-6 rounded-xl border border-slate-100 dark:border-slate-800/50 space-y-6">
                        ...
                        <div className="flex justify-end gap-3 pt-6 border-t border-slate-100 dark:border-slate-800">
                            <button onClick={handleMetaSave} disabled={loading} className="bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-4 rounded-xl font-bold  transition-all flex items-center gap-2">
                ...
                {activeTab === "tesis" && (
                    <div className="space-y-10 ">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            {/* Blue Config */}
                            <div className="bg-slate-50 dark:bg-slate-800/40 p-6 rounded-xl border border-slate-100 dark:border-slate-800/50">
                            ...
                            {/* Green Config */}
                            <div className="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-xl border border-emerald-100 dark:border-emerald-800/50 space-y-6">
                                <div>
                    ...
                    <div className="space-y-10 ">
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="pt-10 border-t border-slate-200 dark:border-slate-800">
                                ...
                                <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
                                    <div className="xl:col-span-4 space-y-6">
                                        <div className="border border-slate-200 dark:border-slate-800 rounded-xl shadow-lg shadow-slate-500/10">
                                            <div className="bg-white dark:bg-slate-900 p-6 rounded-xl">
                                                <h4 className="font-bold flex items-center gap-2 mb-6 text-slate-800 dark:text-white text-lg">
                    ...
                    <div className="p-6 space-y-6 ">
                        ...
                        <div className="print-report bg-white text-black p-8 rounded-xl shadow-sm border border-slate-200" id="report-print-area">
                            ...
                            <div className="mb-8 border-b-2 border-slate-800 pb-6 text-center">
                                <h2 className="text-xl font-bold mb-2 text-slate-900">Su Ayak İzi Raporu</h2>
                            ...
                            <div className="mt-12 pt-6 border-t border-slate-300 text-sm flex flex-col md:flex-row justify-between items-center text-slate-600 font-medium">
                                ...
                                <div className="text-xs text-slate-400">EcoPilot Sürdürülebilirlik Platformu ({new Date().toLocaleDateString('tr-TR')})</div>
                            </div>
                        </div>
                    </div>
                )
...
function KPICard({ title, value, unit, color, icon: Icon }: { title: string, value: number, unit: string, color: string, icon: React.ElementType }) {
    return (
        <div className={`p-6 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl shadow-sm relative overflow-hidden group `}>
            ...
            <div className="flex items-center justify-between mb-2">
                ...
                <div className={`p-2 rounded-xl bg-gradient-to-br ${color} bg-opacity-10 text-white `}>
                    <Icon size={16} />
                </div>
            </div>
...
function TabButton({ id, label, icon: Icon, active, onClick }: { id: string, label: string, icon: React.ElementType, active: string, onClick: (id: string) => void }) {
    ...
    return (
        ...
        >
            ...
            {label}
            {isActive && (
                <div className="absolute bottom-0 left-0 w-full h-1 bg-blue-600 dark:bg-blue-500 rounded-t-full"></div>
            )}
        </button>
    );
}
...
function GreyForm({ reportId }: { reportId: string }) {
    ...
    return (
        <form className="space-y-5" onSubmit={async (e) => {
            ...
            <button type="submit" disabled={loading} className="w-full bg-slate-900 dark:bg-blue-600 text-white py-4 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-slate-800 dark:hover:bg-blue-500 transition-all  active:scale-95 disabled:opacity-50">
