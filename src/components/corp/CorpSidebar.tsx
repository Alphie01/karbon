            ...
            <div className={clsx(
                ...
                <div className="p-6 border-b border-slate-800 flex justify-between items-center">
                    <Link href="/corp/dashboard" className="flex items-center gap-2 group">
                        <div className="h-8 w-8 bg-emerald-600 rounded-lg flex items-center justify-center font-bold text-white group-hover:scale-110 transition-transform text-xs">
                            EP
                        </div>
