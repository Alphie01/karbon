                        ...
                        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="bg-white/50 dark:bg-slate-900/50 p-4 rounded-xl border border-blue-100/50 dark:border-blue-800/50">
                                ...
                                <ul className="text-sm space-y-1 text-slate-700 dark:text-slate-300">
                                    <li><span className="font-bold">Sunucu:</span> {process.env.NEXT_PUBLIC_MAIL_HOST || "mail.example.com"}</li>
                            ...
                            <div className="bg-white/50 dark:bg-slate-900/50 p-4 rounded-xl border border-blue-100/50 dark:border-blue-800/50">
                                ...
                                <ul className="text-sm space-y-1 text-slate-700 dark:text-slate-300">
                                    <li><span className="font-bold">Sunucu:</span> mail.example.com</li>
